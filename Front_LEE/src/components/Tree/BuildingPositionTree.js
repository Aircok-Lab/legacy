    ...
    return (
      <React.Fragment>
        <div className="flex-shrink-0 pt-2">
          <div className="clearfix" style={{fontFamily:"Noto Sans KR"}}>
        ...
        <div className="flex-fill overflow-auto" style={{height:"100px", fontSize:"13px" ,color:"white",fontFamily:"Noto Sans KR"}}>
