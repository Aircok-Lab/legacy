    ...
    return (
      <div className="col-6 mx-auto">
        <form className="text-blue w3-margin">
          <h2 className="text-center" style={{color:"white",fontFamily:"Noto Sans KR"}}>제품군 등록</h2>
            ...
            <div className="w3-rest text-black">
              <table className="table table-bordered table-sm">
                <thead>
                  <tr>
                    <th />
                    <th style={{width: "100%",color:"white",fontFamily:"Noto Sans KR"}}>측정항목 설정</th>
                  </tr>
                </thead>
                <tbody style={{width: "100%"}}>
                  ...
                  <tr>
                    ...
                    <td style={{width: "100%",color:"white",fontFamily:"Noto Sans KR"}}>PM25</td>
                  </tr>
                  <tr>
                    <td>
                      <div className="form-check">
                    ...
                    <td style={{width: "100%",color:"white",fontFamily:"Noto Sans KR"}}>CO2</td>
                  </tr>
                  <tr>
                    <td>
                      <div className="form-check">
                    ...
                    <td style={{width: "100%",color:"white",fontFamily:"Noto Sans KR"}}>CO</td>
                  </tr>
                  <tr>
                    <td>
                      <div className="form-check">
                    ...
                    <td style={{width: "100%",color:"white",fontFamily:"Noto Sans KR"}}>HCHO</td>
                  </tr>
                  <tr>
                    <td>
                      <div className="form-check">
                    ...
                    <td style={{width: "100%",color:"white",fontFamily:"Noto Sans KR"}}>VOC</td>
                  </tr>
                  <tr>
                    <td>
                      <div className="form-check">
                    ...
                    <td style={{width: "100%",color:"white",fontFamily:"Noto Sans KR"}}>Temperature</td>
                  </tr>
                  <tr>
                    <td>
                      <div className="form-check">
                    ...
                    <td style={{width: "100%",color:"white",fontFamily:"Noto Sans KR"}}>humidity</td>
                  </tr>
                  <tr>
                    <td>
                      <div className="form-check">
                    ...
                    <td style={{width: "100%",color:"white",fontFamily:"Noto Sans KR"}}>Noise</td>
                  </tr>
                </tbody>
              </table>
            </div>
