...
import { addIrSetting } from "actions/System";
...
class Add extends Component {
  ...
  add = () => {
    if (!this.state.postData.serialNumber) {
      ...
      this.props.addIrSetting(this.state.postData);
    }
  };
  handleChange = e => {
  ...
  render() {
    return (
     <form className="text-blue w3-margin">
      ...
      <h3 className="text-center" 
          ...
          ,fontFamily:"Noto Sans KR"}}>IR 디바이스 등록</h3>
      <div className="float-left" style={{marginleft: "517px",marginBottom:"30px"}}>
        <p style={{marginLeft:"440px",fontSize:"20px",marginBottom:"50px",fontFamily:"Noto Sans KR"}}>시리얼 번호</p>
        <input 
          ...
          style={{width: "239px",marginLeft:"441px",marginBottom:"-18px",fontSize:"17px",marginTop:"-32px"}}>
        </input>
    ...
    <div 
      ...
      <p style={{marginLeft:"-48px",fontSize:"20px",marginBottom:"50px",fontFamily:"Noto Sans KR"}}>공기청정기 가동범위 설정</p>
      ...
      <div className="float-left" style={{marginLeft:"17px",marginTop:"-29px",color:"white",fontFamily:"Noto Sans KR"}}>
    ...
    <br></br>
      ...
      <div className="float-left" style={{marginLeft:"20px",color:"white",fontFamily:"Noto Sans KR"}}>
      ...
      <div className="float-left" style={{marginLeft:"17px",color:"white",fontFamily:"Noto Sans KR"}}>
      ...
      <h3 style={{marginLeft:"510px",color:"white",fontFamily:"Noto Sans KR"}}>CO2 설정</h3>
