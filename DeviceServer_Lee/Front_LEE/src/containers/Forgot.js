...
class Forgot extends React.Component {
  ...
  render() {
    ...
    return (
      <div className="app-login-container d-flex justify-content-center align-items-center animated slideInUpTiny animation-duration-3" style={{fontFamily:"Noto Sans KR"}}>
        <div className="app-login-main-content1">
          <div className="app-login-content1" style={{marginTop:"45px",backgroundColor:"transparent",border:"1px solid white"}}>
            <AppBar position="static" color="default" style={{fontFamily:"Noto Sans KR"}}>
              <Tabs
            ...
            >
              <TabContainer dir={theme.direction}>
                <div className="app-login-form1" >
                  <form method="post" action="/" className="myForm">
                    <div className="row">
                      <div className="col-md-3" style={{ lineHeight: "40px" , color:"white",fontFamily:"Noto Sans KR"}}>
                        <label>이름</label>
                      </div>
                    ...
                    <div className="row mb-1 d-flex align-items-center justify-content-between" style={{color:"white"}}>
              ...
              <TabContainer dir={theme.direction}>
                <div className="app-login-form">
                  <form method="post" action="/">
                    ...
                    <div className="row">
                      <div className="col-md-3" style={{ lineHeight: "40px" ,color:"white"}}>
                        <label>아이디</label>
                      </div>
                      <div className="col-md-9">
                        <input
                    ...
                    <div className="row mb-1 d-flex align-items-center justify-content-between">
                      <div className="col text-center" style={{color:"wheat"}}>
                        <Link to="/login" style={{color:"white"}}>로그인</Link>
                      </div>
                    </div>
                  </form>
