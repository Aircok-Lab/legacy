...
// function* sensorListWorker1(action) {
//   try {
//     const res = yield api.post(`setting/getIrSettingBySn?serialNumber=123456789000001`, action.payload);
//     if (responseDataProcess(res.data)) {
//       yield put({
//         type: SENSOR_LIST_SUCCESS,
//         payload: res.data.data
...
//   }
// }
// export function* sensorListWatcher1() {
//   yield takeEvery(SENSOR_LIST_REQUEST1, sensorListWorker1);
// }
...
export default function* rootSaga() {
  ...
  // yield all([fork(sensorListWatcher1)]);
