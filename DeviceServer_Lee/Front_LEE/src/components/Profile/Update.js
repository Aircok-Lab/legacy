    ...
    return (
      <div className="">
        <form className="text-blue w3-margin">
          <h2 className="text-center" style={{color:"white",fontFamily:"Noto Sans KR"}}>내 정보 수정</h2>
        ...
        >
          ...
          <form className="text-blue w3-margin">
            <h2 className="text-center" style={{fontFamily:"Noto Sans KR"}}>암호 변경</h2>
            <div className="w3-row w3-section">
              <div
                className="w3-col w3-padding-right"
                style={{ width: "80px" ,color:"black",fontFamily:"Noto Sans KR" }}
              >
                아이디
              </div>
              <div className="w3-rest">
