...
import MainTableHead from "./mainTableHead_newsjellly";
...
class MonitoringPage extends React.Component {
  ...
  onDetailView4Jelly = (deviceList, param_deviceId ) => {
    //console.log("dfadfdas===function진입");
    console.log(deviceList);
    console.log(param_deviceId); 
    console.log(this.props.authUser.deviceList);
     
    window.open("/newjelly/index.html?devId="+param_deviceId+"&sn="+this.props.authUser.deviceList);
  };
            ...
            <form style={{ width: `${nameTabWidth}` }}>
              ...
              >
                ...
                {this.state.uniqBuildingName.map(name => {
                  return (
                    <option key={name} value={name} style={`${nameTabWidth}`}>
                      {name}
                    </option>
                  );
                })}
            ...
            {this.props.allRecentData &&
              this.props.allRecentData.map((contact, i) => {
                if (
                  ...
                  let deviceList = null;
                  let param_deviceId = null;  // by kod
                  ...
                  if (this.props.authUser.userType === "monitoring")
                       deviceList = this.props.authUser.deviceList;
                        ...
                        param_deviceId = contact.id;  // by kod
                  }
                    ...
                    <tr key={i} style={{ height: `${tableLineHeight}px` }}>
                      ...
                      <td style={{ width: `${nameTabWidth}` }}>                      
                        {days > 1 ? (
                          ...
                          <a onClick={(e) => this.onDetailView4Jelly(deviceList, param_deviceId)}>
                            상세보기
                          </a>                             
                          )}
                      </td>                                         
