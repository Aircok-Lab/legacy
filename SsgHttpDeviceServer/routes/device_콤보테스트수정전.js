      ...
      if (info) {
        ...
        if (info.indoor) {
          ...
          if (deviceType == 1) {
            ...
            // HMW
            console.log("deviceType == 3 || deviceType == 4 에진입");
            var paramPM10 = arr[3];
            var paramPM25 = arr[4];
            var paramCO2 = arr[5];
            var paramHCHO = arr[8];
            ...
            // 기타            
            console.log(" 스마트 에어콕 실내형 기타에 진입");
            var paramPM10 = arr[3];
            var paramPM25 = arr[4];
            var paramCO2 = arr[5];
            var paramHCHO = arr[8];
              ...
              if (addedData) {
                ...
                if (info.version !== arr[13]) {
                  ...
                  if (deviceType == 1) {
                    ...
                    if (serialNum == paramDeviceSN) {
                        console.error("업그레이드 디바이스의 로그 수신");
		 	result =
                      		"0|" +
                      		"00060" +
                      		"|" +
