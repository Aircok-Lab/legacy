              ...
              <form method="post" action="/">
                ...
                <div className="row">
                  ...
                  <FormControl component="fieldset" required>
                    ...
                    >
                      <FormControlLabel value="1" control={<Radio color="primary"/>} label="관리자"/>
                      <FormControlLabel value="0" control={<Radio color="primary"/>} label="사용자"/>
                    </RadioGroup>
                  </FormControl>
                  </div>
                </div>
          ...
          <Dialog open={joinDialogOpen} onClose={this.handleRequestClose}>
            <DialogContent>
              <DialogContentText className="text-center">
                회원가입 승인 요청이 완료되었습니다.<br />담당자의 승인이 완료되면 메일을 보내드립니다.
              </DialogContentText>
            </DialogContent>
            <DialogActions>
