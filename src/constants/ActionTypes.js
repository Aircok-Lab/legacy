...
//// System
export const SYSTEM_ITEM_REQUEST = "SYSTEM_ITEM_REQUEST";
export const SYSTEM_ITEM_SUCCESS = "SYSTEM_ITEM_SUCCESS";
export const SYSTEM_UPDATE_REQUEST = "SYSTEM_UPDATE_REQUEST";
export const SYSTEM_UPDATE_SUCCESS = "SYSTEM_UPDATE_SUCCESS";

//// Sensor
export const SENSOR_ITEM_REQUEST = "SENSOR_ITEM_REQUEST";
export const SENSOR_ITEM_SUCCESS = "SENSOR_ITEM_SUCCESS";
