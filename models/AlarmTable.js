...
var AlarmTable = {
  ...
  getAlarmValue: function(callback) {
    ...
    pool.getConnection(function(err, conn) {
      ...
      // SQL문을 실행합니다.
      var exec = conn.query("Select * from AlarmTable", function(err, result) {
        conn.release(); // 반드시 해제해야 합니다.
        console.log("실행 대상 SQL : " + exec.sql);
  ...
  addAlarmValue: function(sensorType, alarmValue, callback) {
    console.log("addAlarmValueTable 호출됨");
  ...
  updateAlarmValue: function(sensorType, alarmValue, callback) {
  ...
  deleteAlarmValue: function(sensorType, callback) {
    console.log("deleteAlarmValue 호출됨 sensorType : " + sensorType);
    pool.getConnection(function(err, conn) {
      if (err) {
        if (conn) {
          conn.release(); // 반드시 해제해야 합니다.
