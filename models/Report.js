...
var Report = {
  getAVGe3ScoreByDate: function(serialNumber, startDate, endDate, callback) {
    ...
    pool.getConnection(function(err, conn) {
      ...
      var queryString = "select ROUND(AVG(e3Score)) as avg from " + tableName +
  ...
  getCountE3Index: function(serialNumber, startDate, endDate, e3Index, callback) {
    ...
    pool.getConnection(function(err, conn) {
      ...
      //데이터를 객체로 만듭니다.
      var tableName = "Alarm_" + serialNumber;
      var queryString = "select count(e3Index) as count from " + tableName +
                        " where date >= " + "'" + startDate + "'" +
                        " and date < " + "'" + endDate + "'" +
                        " and e3Index = " + e3Index;
      // SQL문을 실행합니다.
