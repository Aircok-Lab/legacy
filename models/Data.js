...
var Data = {
  createTable: function(serialNumber, productInfo, callback) {
    ...
    pool.getConnection(function(err, conn) {
      ...
      if (productInfo.id === 28 || productInfo.id === 29 || productInfo.id === 30 || productInfo.id === 33) {
      sqlStr = sqlStr + " insertDate datetime NOT NULL  DEFAULT NOW(), ";  // 20200810 KOD 추가.
      sqlStr = sqlStr + " pm10_org INT NULL, ";  // 20200810 KOD 추가.
      sqlStr = sqlStr + " pm25_org INT NULL, ";  // 20200810 KOD 추가.
      sqlStr = sqlStr + " co2_org INT NULL, ";  // 20200810 KOD 추가.
      sqlStr = sqlStr + " hcho_org INT NULL, ";  // 20200810 KOD 추가.
      sqlStr = sqlStr + " voc_org INT NULL, ";  // 20200810 KOD 추가.
      sqlStr = sqlStr + " temperature_org FLOAT, ";  // 20200810 KOD 추가.
      sqlStr = sqlStr + " humidity_org FLOAT, ";  // 20200810 KOD 추가.
      sqlStr = sqlStr + " noise_org INT NULL, ";  // 20200810 KOD 추가.
      sqlStr = sqlStr + " co_org INT NULL, ";  // 20200810 KOD 추가.
      }
