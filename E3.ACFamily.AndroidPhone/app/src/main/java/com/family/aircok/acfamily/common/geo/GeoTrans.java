package com.family.aircok.acfamily.common.geo;
public class GeoTrans {
    public static void main(String arg[])
    {
    	GeoTransPoint oTM = new GeoTransPoint(260251, 102254);
    	GeoTransPoint oGeo = GeoTrans.convert(GeoTrans.KATEC, GeoTrans.GEO, oTM);
    	Double lat = oGeo.getY() * 1E6;
    	Double lng = oGeo.getX() * 1E6;
    	System.out.println("lat "+lat+" lng "+lng  +" "+oGeo.getX()+" "+oGeo.getY());
//    	GeoPoint oLatLng = new GeoPoint(lat.intValue(), lng.intValue());  // �ʺ信�� ��밡���� ��ǥ��
    }
