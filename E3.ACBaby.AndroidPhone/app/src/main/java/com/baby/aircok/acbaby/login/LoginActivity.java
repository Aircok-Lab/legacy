...
import com.baby.aircok.acbaby.login.sns.facebook.SNSFacebook;
import com.baby.aircok.acbaby.login.sns.google.SNSGoogle;
import com.baby.aircok.acbaby.login.sns.kakao.SNSKakao;
import com.baby.aircok.acbaby.login.sns.naver.SNSNaver;
...
public class LoginActivity extends BaseActivity implements View.OnClickListener{
    ...
    private void getResponse(ACTransaction tr) {
        ...
        LogUtil.LOGE("LoginActivity  kind: " + kind +" getResponse: " + respone.toString());
        ...
        if ("email".equals(kind)) {
            ...
            if ("0".equals(result)) {
                ...
                dialog.setIcon(-1);
                dialog.setBtn(-1);
                dialog.setMsg(getString(R.string.dialog_msg_22));
                dialog.show();
            } else if ("1".equals(result)) {
            ...
            if ("1".equals(result)) {
                ...
                String userID = respone.optString("user_id");
                LoginInfo.getInstance().load(respone);
                LogUtil.LOGE("C2Preference.getLoginID(this): " + C2Preference.getLoginID(this));
                LogUtil.LOGE("C2Preference.getLoginPW(this): " + C2Preference.getLoginPW(this));
    ...
    protected void onTransactionReceivedOnUiThread(NetworkProcessor networkProcessor, Transaction transaction) {
        ...
        if (transaction instanceof ACTransaction) {
            ...
            LogUtil.LOGE("LoginActivity tr: " + tr.toString());
            getResponse(tr);
        }
    }
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            ...
            case R.id.btn_join:
                ...
                String password = mInputPw.getText().toString();
                String birth = mInputBirth.getText().toString();
                ...
                tr.setConnectionURL(Config.SERVER_URL);
                tr.setRequest("email", mInputEmail.getText().toString());
                tr.setRequest("passwd", AES256Cipher.encode(Config.AES256_KEY, password));
