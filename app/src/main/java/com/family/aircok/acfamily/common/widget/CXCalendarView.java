...
public class CXCalendarView extends LinearLayout {
    ...
    private static final int WEEK_VIEW_COUNT = 6;
    ...
    private void init() {
        ...
        for (int i = 0 ; i < WEEK_VIEW_COUNT ; i++) {
            ...
            //요일
            if (i == 0) {
                addView(week, new LinearLayout.LayoutParams(-1, -2));
            }
            else {
                addView(week, new LinearLayout.LayoutParams(-1, 0, 1));
            }
            mRows.add(week);
        }
    }
    ...
    private void initLayout() {
        ...
        for (LinearLayout layout : mRows) {
            for (int j = 0 ; j < 7 ; j++) {
                ...
                layout.addView(view, new LinearLayout.LayoutParams(0, -1, 1));
            }
            i++;
        }
