package com.family.aircok.acfamily.common.push;
...
public class FirebaseMessagingService extends com.google.firebase.messaging.FirebaseMessagingService {
    ...
    public void onMessageReceived(RemoteMessage remoteMessage) {
        ...
        LogUtil.LOGE("From: " + remoteMessage.getFrom());

        // Check if message contains a data payload.
        if (remoteMessage.getData().size() > 0) {
            LogUtil.LOGE("Message data payload: " + remoteMessage.getData());
        }

        // Check if message contains a notification payload.
        if (remoteMessage.getNotification() != null) {
            LogUtil.LOGE("Message Notification Body: " + remoteMessage.getNotification().getBody());
        }
...
//                .setContentTitle(Config.sAppName)
//                .setContentText(msg)
//                .setAutoCancel(true)
