...
public class C2HTTPTransaction extends HTTPTransaction {
    ...
    public static final String C2_CONNECTION_URL_GETMINUDUSTFRCSTDSPTH = "http://openapi.airkorea.or.kr/openapi/services/rest/ArpltnInforInqireSvc/getMinuDustFrcstDspth";
